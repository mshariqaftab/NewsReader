...
/**
 * Created by Mohd. Shariq on 29/03/17.
 */

public class Preferences {private static final String DEFAULT_SUFFIX = "_preferences";
     ...
     * @param key   The name of the preference to modify.
     * @param value The new value for the preference.
     * @see Editor#putStringSet(String, java.util.Set)
    ...
    public final static class Builder {
         ...
         * @return the {@link com.nerdapplabs.msoauth2.utility.Preferences.Builder} object.
         */
         ...
         *
         * @param context the application context
         * @return the {@link com.ms.newsreader.util.Preferences.Builder} object.
         */
